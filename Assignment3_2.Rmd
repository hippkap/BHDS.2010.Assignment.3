...
```{r}
# as another bonus, we wanted to conduct a paired t-test to see if the decreasing in texting behavior among the two groups was statistically significant. we chose a paired t-test as each participant has repeated measures. 
